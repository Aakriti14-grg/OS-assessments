...
This phase focuses on understanding how networks are configured, how data moves across networks, and how system performance is influenced by network design. The concepts discussed form the foundation for secure, efficient, and scalable system communication.
...
1. The device obtains an IP address via DHCP  
2. Firewall rules inspect traffic  
3. DNS resolves the domain name  
4. Requests are routed to the destination server  
...
Different systems communicate using structured interaction models.
...
Choosing the correct communication pattern improves scalability, resilience, and performance.

---

## Conclusion

Week 5 explored the fundamentals of network configuration, layered architectures, addressing, performance metrics, and communication models. These concepts underpin secure and efficient system design. Understanding how networks are structured, monitored, and integrated enables administrators to build scalable systems while maintaining performance and security.
